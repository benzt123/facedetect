...
# 定义多个椭圆参数
ellipses = [
    {"center": (100, 100), "axes": (50, 30), "angle": 0, "k": 0.001},
    {"center": (200, 200), "axes": (60, 40), "angle": 0, "k": 0.01},
    {"center": (150, 250), "axes": (40, 20), "angle": 0, "k": 0.05}
]

# 应用透镜效果
result = apply_lens_effect(image, ellipses)

# 显示结果
cv2.imshow('Original Image', image)
cv2.imshow('Multiple Lens Effects', result)
cv2.waitKey(0)
